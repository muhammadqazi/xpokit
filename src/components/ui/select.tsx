...
const selectTv = tv({
  slots: {
    ...
    input:
      'border-grey-50 dark:bg-white-800 mt-0 flex-row items-center justify-center rounded-3xl border-[0.5px]  border-neutral-300 p-3 dark:border-neutral-500',
      ...
      <View className={styles.container()}>
        ...
        >
          <View className="flex-1">
            <Text
              className={`${styles.inputValue()} ${value === undefined ? styles.placeholder() : ''}`}
            >
              {textValue}
            </Text>
          </View>
